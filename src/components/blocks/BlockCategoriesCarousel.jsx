...
export default class BlockCategoreisCarousel extends Component {
    handleNextClick = () => {
        if (this.slickRef) {
    ...
    render() {
        ...
        const columns = this.productsColumns().map((column, index) => {
            const products = column.map((category) => (
...
BlockCategoreisCarousel.propTypes = {
...
BlockCategoreisCarousel.defaultProps = {
    layout: 'grid-4',
    rows: 1,
    products: [],
    groups: [],
